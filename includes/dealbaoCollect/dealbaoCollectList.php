...
<!--<link rel="stylesheet" href="--><?php //echo DEALBAO_DIR_URL?><!--lib/zTree/css/zTreeStyle/zTreeStyle.css" type="text/css">-->
<!--<link rel="stylesheet" type="text/css" href="--><?php //echo DEALBAO_DIR_URL?><!--css/demo.css">-->
<!--<link rel="stylesheet" type="text/css" href="--><?php //echo DEALBAO_DIR_URL?><!--css/style.css">-->
...
?>
    ...
    <div class="wrap" >
        ...
        <h2><?php _e('Collect List','dealbao') ?></h2>
                ...
                <tr>
                    ...
                    <td class="widthHeight" style="width: 600px!important;">
                        <table class="table table-bordered" style="height: 50px;width: 596px;margin: 2px;">
                            ...
                            <tbody>
                            <tr>
                                <td colspan="4" align="left" style="border-left: 1px solid #e6e6e6;border-top:  1px solid #e6e6e6;"><a  href="" title="<?php echo $value['goods_name'] ;?>" style="width: 462px;display: inline-block;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;" target="_blank"><?php echo $value['goods_name']; ?></a> </td>
                    ...
                    <td  class="widthHeight"  style="width: 450px!important;">
                        <table class="table table-bordered layui-table  "  style="height: 50px;width: 446px;margin: 2px;">
                            ...
                            <tr>
                                ...
                                <td class="leftRightBottom" style="border-right:  1px solid #e6e6e6;"><?php echo $value['create_time'] ;?></td>
                            </tr>
...
<?php
wp_enqueue_script('dealbao_collect_tree_list', DEALBAO_DIR_URL . 'js/dealbao_collect_tree_list.js', array('jquery'));
?>
